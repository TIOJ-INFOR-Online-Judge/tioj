module CompilerHelper
  COMPILER_LIST = [
    ["language-cpp", ".cpp", "c++17/gnu c++ compiler 15.2.0 | options: -O2 -std=c++17", "c++17"],
    ["language-cpp", ".cpp", "c++20/gnu c++ compiler 15.2.0 | options: -O2 -std=c++20", "c++20"],
    ["language-cpp", ".cpp", "c++23/gnu c++ compiler 15.2.0 | options: -O2 -std=c++23", "c++23"],
    ["language-cpp", ".cpp", "c++14/gnu c++ compiler 15.2.0 | options: -O2 -std=c++14", "c++14"],
    ["language-cpp", ".cpp", "c++11/gnu c++ compiler 15.2.0 | options: -O2 -std=c++11", "c++11"],
    ["language-cpp", ".cpp", "c++98/gnu c++ compiler 15.2.0 | options: -O2 -std=c++98", "c++98"],
    ["language-c", ".c", "c17/gnu c compiler 15.2.0 | options: -O2 -std=c17 -lm", "c17"],
    ["language-c", ".c", "c11/gnu c compiler 15.2.0 | options: -O2 -std=c11 -lm", "c11"],
    ["language-c", ".c", "c99/gnu c compiler 15.2.0 | options: -O2 -std=c99 -lm", "c99"],
    ["language-c", ".c", "c90/gnu c compiler 15.2.0 | options: -O2 -ansi -lm", "c90"],
