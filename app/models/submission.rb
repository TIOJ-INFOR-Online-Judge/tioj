...
#  proxy_judge_type  :integer          default(0), not null
#  proxy_judge_nonce :string(255)
#  proxy_judge_id    :string(255)
#
# Indexes
#
...
#  index_submissions_fetch                     (proxy_judge_type,result,priority DESC,id)
