...
#  index_submissions_old_user_problem_result                    (contest_id,user_id,result,old_result,problem_id)
#  index_submissions_old_user_query                             (contest_id,user_id,problem_id,old_result)
#  index_submissions_old_user_result                            (contest_id,user_id,result,old_result)
#  index_submissions_on_contest_id                              (contest_id)
#  index_submissions_on_contest_id_and_new_rejudged_and_id      (contest_id,new_rejudged,id)
#  index_submissions_on_contest_id_and_new_rejudged_and_result  (contest_id,new_rejudged,result)
